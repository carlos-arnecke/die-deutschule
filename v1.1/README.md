# German Level Test — v1.1 (working copy)
...
| `01-theory-and-framework.md` | **For the teachers.** What the test is built on — CEFR, *Profile deutsch*, the telc/Goethe inventories, multistage testing, self-assessment research — with sources. Also the honest account of what it is not |
...
1. **The teachers' review.** Send `01-theory-and-framework.md` and `for-teachers-review.md` together. Every question now carries a Basis line; two B1 questions (B1-03, B1-04) are flagged as A2/B1 boundary cases for their call.
