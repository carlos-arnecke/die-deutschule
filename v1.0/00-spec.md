# Level Test + Lead Capture — Spec (v2)

**Status:** working prototype, logic-first. No visual design yet (deliberate — see §9).
**Location:** `W:\Active Projects\Die Deutschule\2026\German Test\`
...
### 3.1 Design: adaptive ladder (staged, not per-item CAT)
...
`data/items.js` — 50 questions, 10 per level, tagged by level, skill and grammar point. Format and editing rules in `data/README-items.md`.
...
```
index.html                 shell + the (plain) CSS
